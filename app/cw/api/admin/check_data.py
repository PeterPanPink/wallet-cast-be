...
from ...api.utils import ApiSuccess, ApiFailure, api_failure, make_response, CorebeResult, CorebeError, verify_api_key
...
@router.get('/{rule_name}/{check_id}', response_model=DataCheckSuccess | ApiFailure | CorebeResult | CorebeError)
async def admin_check_data(
    ...
    try:
        ...
        return make_response(DataCheckSuccess(results=result_data), is_corebe)
