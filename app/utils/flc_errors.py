...
class FlcStatusCode(int, Enum):
    """HTTP status codes for FlcError exceptions."""
...
class FlcErrorCode(str, Enum):
    """Error codes for FlcError exceptions."""
    ...
    # External Services
    E_CBX_LIVE_ERROR = "E_CBX_LIVE_ERROR"
...
class FlcError(Exception):
    def __init__(
        self,
        errcode: FlcErrorCode,
        errmesg: str,
        status_code: FlcStatusCode = FlcStatusCode.INTERNAL_SERVER_ERROR,
    ):
