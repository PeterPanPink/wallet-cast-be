...
router = APIRouter(prefix="/flc/session/ingress", tags=["Next Phase"])
...
async def enable_caption(
    ...
    return CwOut[EnableCaptionResponse](
...
@router.post("/disable_caption", response_model=CwOut[DisableCaptionResponse])
async def disable_caption(
    params: DisableCaptionRequest,
    user: CurrentUser,
    w: Annotated[Worker, Depends(get_caption_worker)],
    service: SessionService = Depends(get_session_service),
) -> CwOut[DisableCaptionResponse]:
    ...
    return CwOut[DisableCaptionResponse](
...
@router.post("/get_caption_status", response_model=CwOut[CaptionStatusResponse])
async def get_caption_status(
    params: CaptionStatusRequest,
    user: CurrentUser,
    service: SessionService = Depends(get_session_service),
) -> CwOut[CaptionStatusResponse]:
    ...
    if not agent_data:
        # No agent running
        return CwOut[CaptionStatusResponse](
...
@router.post("/update-language", response_model=CwOut[UpdateParticipantLanguageResponse])
async def update_participant_language(
    params: UpdateParticipantLanguageRequest,
    service: SessionService = Depends(get_session_service),
) -> CwOut[UpdateParticipantLanguageResponse]:
    ...
    return CwOut[UpdateParticipantLanguageResponse](
