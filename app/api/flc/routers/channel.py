...
from app.api.flc.schemas.channel import (
    ChannelOut,
    CreateChannelIn,
    CreateChannelOut,
    ListChannelsOut,
...
router = APIRouter(prefix="/flc/channel")
...
async def create_channel(
    ...
    return CwOut[CreateChannelOut](results=CreateChannelOut(channel_id=result.channel_id))
