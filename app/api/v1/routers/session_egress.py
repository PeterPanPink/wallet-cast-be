...
from app.api.v1.schemas.session_egress import (
    ClientPlatform,
    EndLiveStreamIn,
    EndLiveStreamOut,
    StartLiveStreamIn,
...
router = APIRouter(prefix="/session/egress")
...
async def start_live_stream(
    ...
    return ApiOut[StartLiveStreamOut](
...
async def end_live_stream(
    ...
    try:  # noqa: FLC002
        ...
        if e.errcode == AppErrorCode.E_SESSION_NOT_FOUND:
            ...
            return ApiOut[EndLiveStreamOut](
