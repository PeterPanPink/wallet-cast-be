...
class ExternalLiveApiSuccess(BaseModel):
    """External Live API success response."""
...
class ExternalLiveApiFailure(BaseModel):
    """External Live API failure response."""
...
class ExternalLiveApiResponse(RootModel[ExternalLiveApiSuccess | ExternalLiveApiFailure]):
    """Standard External Live API response wrapper.
