"""
Mock implementation of the core-be authentication endpoints.
...
Run with granian:
    granian --interface ASGI --host 127.0.0.1 --port 18080 tools.mock_corebe:app

Then point COREBE_API_URL to http://127.0.0.1:18080 (e.g. in env.local / env.example).
"""
...
app = FastAPI(title="core-be mock", version="0.3.0")
...
async def health():
    ...
    return {"status": "ok", "service": "mock-corebe"}
