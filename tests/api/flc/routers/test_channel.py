...
from app.api.flc.routers.channel import get_channel_service, router
...
class TestCreateChannel:
    """Tests for POST /flc/channel/create_channel endpoint."""
    ...
    def test_create_channel_success(
        ...
        # Act
        response = client.post("/flc/channel/create_channel", json=payload)
...
class TestListChannels:
    """Tests for GET /flc/channel/list_channels endpoint."""
    ...
    def test_list_channels_success(
        ...
        # Act
        response = client.get("/flc/channel/list_channels")
...
class TestUpdateChannel:
    """Tests for POST /flc/channel/update_channel endpoint."""
    ...
    def test_update_channel_success(
        ...
        # Act
        response = client.post("/flc/channel/update_channel", json=payload)
    ...
    def test_update_channel_not_found(
        ...
        # Arrange
        mock_channel_service.update_channel.side_effect = FlcError(
...
class TestGetUserConfigs:
    """Tests for GET /flc/channel/get_user_configs endpoint."""
    ...
    def test_get_user_configs_channel_not_found(
        ...
        """Should return 404 when channel not found."""
        # Arrange
        mock_channel_service.get_user_configs.side_effect = FlcError(
            errcode=FlcErrorCode.E_CHANNEL_NOT_FOUND,
            errmesg="Channel not found",
            status_code=FlcStatusCode.NOT_FOUND,
        )
    ...
    def test_get_user_configs_missing_channel_id(self, client: TestClient):
        ...
        # Act
        response = client.get("/flc/channel/get_user_configs")
...
class TestUpdateUserConfigs:
    """Tests for POST /flc/channel/update_user_configs endpoint."""
    ...
    def test_update_user_configs_success(
        ...
        # Act
        response = client.post("/flc/channel/update_user_configs", json=payload)
    ...
    def test_update_user_configs_channel_not_found(
        ...
        """Should return 404 when channel not found."""
        # Arrange
        mock_channel_service.update_user_configs.side_effect = FlcError(
            errcode=FlcErrorCode.E_CHANNEL_NOT_FOUND,
            errmesg="Channel not found",
            status_code=FlcStatusCode.NOT_FOUND,
        )
