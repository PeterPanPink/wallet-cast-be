...
from app.api.flc.routers.session_ingress import get_session_service, router
...
class TestCreateRoom:
    """Tests for POST /flc/session/ingress/create_room endpoint."""
    ...
    def test_create_room_success_with_session_id(
        ...
        # Act
        with patch("app.api.flc.routers.session_ingress.get_app_environ_config") as mock_config:
            mock_config.return_value.MAX_PARTICIPANTS_LIMIT = 100
            response = client.post("/flc/session/ingress/create_room", json=payload)
...
class TestDeleteRoom:
    """Tests for POST /flc/session/ingress/delete_room endpoint."""
    ...
    def test_delete_room_success_with_session_id(
        ...
        # Act
        response = client.post("/flc/session/ingress/delete_room", json=payload)
...
class TestGetHostToken:
    """Tests for POST /flc/session/ingress/get_host_token endpoint."""
    ...
    def test_get_host_token_success_with_session_id(
        ...
        with patch("app.api.flc.routers.session_ingress.get_app_environ_config") as mock_config:
            ...
            response = client.post("/flc/session/ingress/get_host_token", json=payload)
...
class TestGetGuestToken:
    """Tests for POST /flc/session/ingress/get_guest_token endpoint."""
    ...
    def test_get_guest_token_success_with_can_publish(
        ...
        with patch("app.api.flc.routers.session_ingress.get_app_environ_config") as mock_config:
            mock_config.return_value.LIVEKIT_URL = "wss://test.livekit.cloud"
            response = client.post("/flc/session/ingress/get_guest_token", json=payload)
...
class TestGetRecorderToken:
    """Tests for POST /flc/session/ingress/get_recorder_token endpoint."""
    ...
    def test_get_recorder_token_success(
        ...
        with patch("app.api.flc.routers.session_ingress.get_app_environ_config") as mock_config:
            mock_config.return_value.LIVEKIT_URL = "wss://test.livekit.cloud"
            response = client.post("/flc/session/ingress/get_recorder_token", json=payload)
...
class TestUpdateRoomMetadata:
    """Tests for POST /flc/session/ingress/update_room_metadata endpoint."""
    ...
    def test_update_room_metadata_success(
        ...
        # Act
        response = client.post("/flc/session/ingress/update_room_metadata", json=payload)
    ...
    def test_update_room_metadata_invalid_json(
        ...
        # Arrange
        mock_session_service.get_session.return_value = sample_session
        mock_session_service.update_room_metadata.side_effect = FlcError(
...
class TestUpdateParticipantName:
    """Tests for POST /flc/session/ingress/update_participant_name endpoint."""
    ...
    def test_update_participant_name_success(
        ...
        # Act
        response = client.post("/flc/session/ingress/update_participant_name", json=payload)
