...
from app.api.v1.routers.session_viewer import router
...
class TestGetPlaybackUrl:
    """Tests for GET /session/viewer/get_playback_url endpoint."""
    ...
    async def test_get_playback_url_live_session(
        ...
        response = await client.get(
            "/session/viewer/get_playback_url",
    ...
    async def test_get_playback_url_missing_query_param(
        ...
        # Act
        response = await client.get("/session/viewer/get_playback_url")
