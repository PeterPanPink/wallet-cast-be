...
from app.api.v1.routers.session import get_session_service, router
...
class TestCreateSession:
    """Tests for POST /session/create_session endpoint."""
    ...
    def test_create_session_success(
        ...
        # Act
        response = client.post("/session/create_session", json=payload)
    ...
    def test_create_session_channel_not_found(
        ...
        # Arrange
        mock_session_service.create_session.side_effect = AppError(
...
class TestListSessions:
    """Tests for GET /session/list_sessions endpoint."""
    ...
    def test_list_sessions_success(
        ...
        # Act
        response = client.get("/session/list_sessions")
...
class TestGetSession:
    """Tests for GET /session/get_session endpoint."""
...
class TestGetActiveSession:
    """Tests for GET /session/get_active_session endpoint."""
    ...
    def test_get_active_session_not_found(
        ...
        # Arrange
        mock_session_service.get_active_session_by_channel.side_effect = AppError(
            errcode=AppErrorCode.E_SESSION_NOT_FOUND,
    ...
    def test_get_active_session_missing_channel_id(
        ...
        # Act
        response = client.get("/session/get_active_session")
...
class TestUpdateSession:
    """Tests for POST /session/update_session endpoint."""
    ...
    def test_update_session_by_session_id(
        ...
        # Act
        response = client.post("/session/update_session", json=payload)
...
class TestEndSession:
    """Tests for POST /session/end_session endpoint."""
    ...
    def test_end_session_no_params(
        ...
        """Should return 400 when neither session_id nor room_id provided."""
        # Act
        response = client.post("/session/end_session")
    ...
    def test_end_session_invalid_state(
        ...
        mock_session_service.get_session.return_value = existing
        mock_session_service.end_session.side_effect = AppError(
            errcode=AppErrorCode.E_SESSION_END_FAILED,
